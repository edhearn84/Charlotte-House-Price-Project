---
title: "NSA Charlotte Data Codes"
...
Data import - NSA Charlotte housing data

```{r}

load(file = "nsa_clt.Rdata")
nsa_clt_df = nsa_clt
...
# Overall treatment
summary( lm_robust(
  lrsp ~ rezone + post2002 + treat + acres + beds + baths + half_baths + new + age + agesq + 
         Over64 + DO + FS + RMedIncHH + VCR + year_fe , 
                data = treated_df ,
                se_type = "stata" ,
                clusters = treated_df$subdiv) )
...
# Treatment-by-year
summary( lm_robust(
  lrsp ~ rezone + acres + beds + baths + half_baths + new + age + agesq + 
         Over64 + DO + FS + RMedIncHH + VCR + year_fe , 
                data = treated_df ,
                se_type = "stata" ,
                clusters = treated_df$subdiv) )
...
# Positively treated 
summary(lm_robust(
  lrsp ~ rezonepos + post2002 + treatpos + acres + beds + baths + half_baths + new + age + agesq + 
         Over64 + DO + FS + RMedIncHH + VCR + year_fe , 
                data = treated_pos_df , 
                se_type = "stata" ,
                clusters = treated_pos_df$subdiv) )
...
# Year-over-year
summary(lm_robust(
  lrsp ~ rezonepos + acres + beds + baths + half_baths + new + age + agesq + 
         Over64 + DO + FS + RMedIncHH + VCR + year_fe + year_fe*rezonepos , 
                data = treated_pos_df , 
                se_type = "stata" ,
                clusters = treated_pos_df$subdiv) )
...
# Negatively treated
summary( lm_robust(
  lrsp ~ rezoneneg + post2002 + treatneg + acres + beds + baths + half_baths + new + age + agesq + 
            Over64 + DO + FS + RMedIncHH + VCR + year_fe , 
                data = treated_neg_df , 
                se_type = "stata" ,
                clusters = treated_neg_df$subdiv) )
...
# Year-over-year
summary( lm_robust(
  lrsp ~ rezoneneg + acres + beds + baths + half_baths + new + age + agesq +
           Over64 + DO + FS + RMedIncHH + VCR + year_fe + year_fe*rezoneneg , 
                data = treated_neg_df , 
                se_type = "stata" ,
                clusters = treated_neg_df$subdiv) )
...
summary(lm_robust(
  lrsp ~ eocdifference + post2002 + eocptreat + acres + beds + baths + half_baths + new + age + agesq + 
                Over64 + DO + FS + RMedIncHH + VCR + year_fe , 
                data = treated_pos_df , 
                se_type = "stata" ,
                clusters = treated_pos_df$subdiv) )
...
pos_yearly = lm_robust(
  lrsp ~ eocdifference + acres + beds + baths + half_baths + new + age + agesq + 
                Over64 + DO + FS + RMedIncHH + VCR + year_fe + eocdifference*year_fe , 
                data = treated_pos_df , 
                se_type = "stata" ,
                clusters = treated_pos_df$subdiv)
...
summary( lm_robust(
  lrsp ~ eocdifference + post2002 + eocntreat + acres + beds + baths + half_baths + new + age + agesq + 
                Over64 + DO + FS + RMedIncHH + VCR + year_fe , 
                data = treated_neg_df , 
                se_type = "stata" ,
                clusters = treated_neg_df$subdiv) )
